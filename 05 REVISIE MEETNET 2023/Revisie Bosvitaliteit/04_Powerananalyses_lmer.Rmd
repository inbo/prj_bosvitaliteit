...
Voor de volledige dataset hebben ze een variatie (uitgedrukt als standaarddeviatie) tussen de proefvlakken van ongeveer 0.07 (zie figuur \@ref(fig:vcfull)), wat ook toevallig hetzelfde cijfer is voor de residuele variatie. De variatie tussen de bomen bedraagt rond de 0.09.
...
Indien we aggregeren op plotniveau blijft dit voor de variatie tussen de plots in dezelfde grootte-orde met 0.06 (zie figuur \@fig(fig:jpjagg)). De residuele standdaardeviatie bedraagt rond de 0.03 (nu is dit een combiatie van de variatie per boom en de residuele variatie van het vorige model).
...
Om een correcte analyse te hebben zou de random helling ook eens op 20 jaar moeten berekend worden, en hier zal vermoedelijk het effect van deze helling een stuk kleiner zijn, en dus de steekproef veel krachtiger zijn. _*<<<Uit de gegevens blijkt dat op 20 jaar de standaarddeviatie op de trend nog ongeveer 0.005 is in plaats van 0.0065.Toch is dit niet overtuigend>>>*_
...
Zoals verwacht blijkt uit figuur \@ref(fig:rsiminstelvarstrend) heeft de te detecteren trend een heel grote invloed op de kracht. Hoe groter het effect is dat ten minste gedetecteerd moet worden, hoe meer kans en dus kracht dat het model dit effect zal kunnen detecteren.
...
Uit figuur \@ref(fig:rsiminstelvarscor) blijkt dat de correlatie tussen intercept en helling in de tijd een verwaarloosbare invloed te hebben op de power in de huidige setup.
