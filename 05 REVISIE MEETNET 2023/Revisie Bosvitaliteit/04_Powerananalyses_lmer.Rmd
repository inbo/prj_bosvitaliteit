...
```{r jpjpwr, cache = TRUE, message = FALSE}
...
```{r simrfixedvars, message = FALSE, fig.cap="Powerberekening voor de berekende instelvariabelen voor 20 tot 120 proefvlakken voor detectie van 12% op 12 jaar en 20% op 20 jaar"}
