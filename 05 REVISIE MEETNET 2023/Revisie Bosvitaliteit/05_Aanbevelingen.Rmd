...
Daarnaast moet ook duidelijk gemaakt worden waarvoor dit meetnet nog nuttig is, zoals bijvoorbeeld de reactie van Vlaamse bossen op klimaatevoluties.
...
Om ruimtelijke balancering te garanderen kan ook het grts  van de bosinventarisatie gebuikt worden om nieuwe plots toe te voegen, op voorwaarde ze voldoen aan de bosvitaliteitsvereisten, namelijk minstens 4km uit elkaar, en een plot moet volledig binnen een bos vallen.
