...
Deels overlappend met dit meetnet en met dezelfde methodologie wordt ook de essenziekte onderzocht, maar het plan is dit heel binnenkort stop te zetten wegens de grote uitval door het aantal bomen dat sterft aan de gevolgen van de ziekte. Dit neemt heel extreme proporties aan, waar in enkele jaren tijd reeds één derde van de bomen dood is.
...
Om ruimtelijke balancering te garanderen kan een ruimtelijk gebalanceerde steekproeftrekking (bv GRTS algoritme) uit het bosinventarisatie-raster gebuikt worden om nieuwe plots toe te voegen, op voorwaarde dat ze voldoen aan de bosvitaliteitsvereisten, namelijk minstens 4 km uit elkaar, en een plot moet volledig binnen een bos vallen.

### Verouderende proefvlakken

Doordat het verouderen van de bomen zelf een steeds belangrijkere factor wordt in de evolutie van het bladverlies zelf, dekt dit meetnet niet meer volledig de doelstelling, daarom moet een goede vervangingstrategie worden uitgewerkt over hoelang proefvlakken in de dataset blijven en hoe die vervangen moeten worden, zodat de bosvitaliteit representatief blijft voor de gezondheidstoestand van de bomen in Vlaanderen. Nieuwe steekproefpunten selecteren op basis van een ruimtelijk gebalanceerde trekking (grtsà lijkt alvast een goede start.
