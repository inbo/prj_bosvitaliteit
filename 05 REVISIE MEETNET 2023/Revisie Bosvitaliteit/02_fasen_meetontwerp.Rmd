...
In eerste instantie wil ik Geert Sioen bedanken dat hij heel transparant alle gevraagde gegevens wou geven rond het meetnet en dat hij tijd heeft genomen mij eens mee te nemen op het veld om te zien wat ik me moet voorstellen bij de metingen die in het kader van het Level-I meetnet gebeuren.
...
Daarnaast kan het ook interessant zijn om te zien welk verschil gedetecteerd kan worden tussen 2 opeenvolgende jaren, want hoe krachtiger dit is, hoe krachtiger ook het meetnet zal zijn op langere termijn.
...
Om hiervoor uitspraken te onderbouwen, zal een aangepast aantal steekproefpunten nodig zijn.
...
Aangezien de visuele beoordeling gedaan in klassen van 5%, wat vrij gedetailleerd is, is het belangrijk de bomen grondig te bekijken, zodat de metingen relevant zijn en niet teveel afwijken vertonen. 

Het bladverlies geldt als proxy voor de vitaliteit van de bomen.
Er wordt met een grens gewerkt van 25%, waarbij bomen met 25% of minder bladverlies als gezond worden aanzien en bomen met meer als beschadigd.
...
Verder wordt nog een meer gedetailleerde symptoombeschrijving uitgevoerd die vooral een visuele inspectie inhoudt van verschillende symptomen die in relatie staan tot de gezondheid van de boom. Dit gebeurt zowel op kroon, takken en stam.
...
In vergelijking met andere landen is ons meetnet veel dichter.
