...
Alle gridpunten die in bos vallen in een 16 x 16 km Europees grid moeten jaarlijks gerapporteerd worden in termen van  blad- of naadverlies (Level-I meetnet) en in detail voor andere kenmerken zoals bv. stikstof- en koolstofdepositie (Level-II meetnet).

<!--hvc: dus naar EU worden enkel de data van de proefvlakken die op 16 x 16 km doorgegeven? Hoeveel zijn dit er in Vlaanderen en in België. Kan je dat toevoegen?-->

<!--Liggen de level I proefvlakken vast? Of wordt het steekproefkader om de x jaar aangepast: als er nieuw bos komt of als er bos verdwijnt? In de manual lees ik hierover: If the stand is cut, wind thrown or destroyed in any other way, there are two
possibilities to continue monitoring: (i) no crown condition data will be submitted until a new
stand has developed in the same location, or (ii) establish a new plot in a stand nearby (see
Manual Part II Basic Design Principles for details). A periodic revision of the Level I grid for
adaptation to changes of forest area has to be conducted and reported to PCC by the
submission of data on respective new or revised plots.-->
...
<!--hvc: toestand van wat juist? In de ICP forest rapporten gaat het vaak over gemiddeld bladverlies-->
...
<!--hvc is deze vorige zin nog nodig?-->
...
<!--hvc: Kan je hier toevoegen hoeveel proefvlakken per dag beoordeeld kunnen worden?-->
...
<!--hvc: kan je hier enkele voorbeelden van de rapporten citeren?-->
...
<!--hvc: kan je hier verwijzen naar de indicatorenwebsite waar deze indicatoren getoond wordt?-->
...
De resultaten van ICP forests worden bezorgd aan de Europese commissie.

<!--hvc: en hier een citatie van zo'n ICP forest rapport-->
...
<!--hvc indien relevant ook de low & high van de balken in de figuur verklaren-->
...
In kader van het meetnet zelf kan niet veel gedaan worden met deze extra variabelen. <!--hvc: waarom? Ik zou dit niet zo schrijven. In de volgende zin geef je net aan waarom dit nuttig is.-->
...
<!--hvc: bovenstaande paragraaf bevat een aanbeveling (protocol opstellen) die je kan toevoegen aan sectie 5.4.1-->
...
<!-- hvc: dit deeltje hoort thuis bij het volgende punt, maar daar is het al besproken. Dus vermoedelijk mag deze paragraaf weg:
...
<!--hvc: hoe komt het dat de nieuwste proefvlakken nog niet werder toegevoegd?-->
...
<!--hvc: zie https://www.vlaanderen.be/inbo/en-gb/open-data-policy/ dus voorkeur gaat sterk uit naar CC0-->
...
<!--hvc: in voorgaande zin best cross-ref naar hoofdstuk toevoegen-->
...
<!--hvc tenzij je kan verwijzen naar een rapport, zou ik de eerste zin van deze sectie herschrijven: We kunnen ook een verklarend model maken om ...-->
...
<!--hvc hier ook best voorbeeldrapportjes, website, etc citeren-->
...
<!--hvc volgende zinnen kunnen weg denk ik. Horen hier niet echt thuis en zijn al elders geschreven:
