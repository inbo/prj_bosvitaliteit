...
Alle gridpunten die in bos vallen in een 16 x 16 km Europees grid moeten jaarlijks gerapporteerd worden in termen van  blad- of naaldverlies (Level-I meetnet) en in detail voor andere kenmerken zoals bv. stikstof- en koolstofdepositie (Level-II meetnet).
...
<!--hvc: wordt de 25% grens voor bladverlies op plotniveau ook gebruikt op steekproefniveau? Gemiddelde bladverlies van meer of minder dan 25%?-->
...
Indien een boom meer dan 25% kroonverlies heeft, wordt deze boom als beschadigd gezien. Naast het gemidddeld bladverlies in een proefvlak kan het aandeel beschadigde bomen in een proefvlak gebruikt worden om de gezondheidstoestand op te volgen, maar deze laatste methode verliest aan populariteit en de Europese rapporten richten zich meer en meer op gemiddeld bladverlies. 
...
Er wordt nooit een proefvlak bezocht zonder expliciete toestemming van de eigenaar.
...
In het bosvitaliteitsmeetnet zijn duidelijk heel wat meer grove dennen, inlandse eiken en beuken aanwezig, en is er een duidelijke ondervertegenwoordiging van berken, elsen en Amerikaanse vogelkersen.
...
Voor het huidige meetnet is het doenbaar om alle metingen in optimale omstandigheden uit te voeren, namelijk in de zomer wanneer het kroondak het beste gesloten is en enkel op dagen waar het weer voldoende goed is, zodat alle metingen zonder problemen uitgevoerd kunnen worden.
...
De visuele inschatting van het bladverlies in klassen van 5% is niet perfect, maar we kunnen vrij zeker zijn dat de beoordeling niet meer dan 1 of 2 klassen zal afwijken van de realiteit.
...
Andere Europese landen kiezen, op Zweden na, er ook voor om telkens dezelfde proefvlakken jaarlijks te boezoeken. 
...
- Jaarlijks wordt ook gerapporteerd naar ICP forests
    ...
    - rapportage van alle proefvlakken voor ICP-forest jaarlijkse statistische analyse   \citep{icpforesttechreport} over de bosvitaliteit in Europa
